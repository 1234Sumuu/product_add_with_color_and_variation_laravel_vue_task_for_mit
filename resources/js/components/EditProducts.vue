            ...
            <v-card-text>
              <v-container>
                ...
                <v-row>
                  ...
                  <v-col cols="12">
                    <v-text-field v-model="data.color" required label="color"></v-text-field>
                  </v-col>
                  <v-col cols="12">
                    <v-text-field v-model="data.image" required label="<i class="fas fa-file-upload    "></i>"></v-text-field>
                  </v-col>
                </v-row>
            <v-card-actions>
              <v-spacer></v-spacer>
